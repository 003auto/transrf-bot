...
COMPANY_DESC = "Логистическая компания федерального масштаба расширяет штат курьеров. Работаем по всей России — от крупных городов до региональных центров."

VACANCIES = {
    "v1": {
        "title": "Пеший курьер",
        "salary": "3 500–6 000 ₽ за смену", "schedule": "Гибкий, смены 8–10 часов", "location": "Вся Россия",
    ...
    "v2": {
        ...
        "salary": "4 500–8 000 ₽ за смену", "schedule": "Гибкий, смены 8–10 часов", "location": "Вся Россия",
    ...
    "v3": {
        "title": "Автокурьер",
        "salary": "5 000–9 000 ₽ за смену", "schedule": "Гибкий, смены 8–10 часов", "location": "Вся Россия",
...
async def show_vacancy(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "about":
        await query.edit_message_text(
            ...
            "• Гибкий выбор смен через приложение\n"
            "• Вакансии открыты по всей территории РФ",
            parse_mode="HTML",
