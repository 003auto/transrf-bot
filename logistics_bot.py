...
REVIEWS = (
    "<b>Отзывы сотрудников ТрансРФ</b>\n\n"
    "⭐️⭐️⭐️⭐️⭐️ <b>Алексей, Москва</b> — пеший курьер, 8 месяцев\n"
    "«Пришёл без опыта, обучили за день. Выплаты реально каждую неделю — ни разу не задержали. "
    "Работаю 4 смены в неделю, зарабатываю стабильно. Доволен.»\n\n"
    "⭐️⭐️⭐️⭐️⭐️ <b>Дмитрий, Екатеринбург</b> — курьер на авто, 1 год\n"
    "«Работал в двух других службах до этого — там постоянные задержки и серые схемы. "
    "Здесь всё официально с первого дня, договор, отчисления. Плюс компенсация топлива — это важно.»\n\n"
    "⭐️⭐️⭐️⭐️⭐️ <b>Марина, Краснодар</b> — пеший курьер, 5 месяцев\n"
    "«Искала подработку с гибким графиком. ТрансРФ подошёл идеально — сама выбираю смены, "
    "не нужно отпрашиваться. Деньги приходят вовремя, поддержка отвечает быстро.»\n\n"
    "⭐️⭐️⭐️⭐️⭐️ <b>Игорь, Новосибирск</b> — курьер на велосипеде, 7 месяцев\n"
    "«Велосипед взял у компании — своего не было. Маршруты удобные, приложение простое. "
    "За пиковые дни платят заметно больше. Рекомендую тем, кто хочет зарабатывать активно.»\n\n"
    "⭐️⭐️⭐️⭐️⭐️ <b>Сергей, Санкт-Петербург</b> — курьер на мото, 11 месяцев\n"
    "«Работаю почти год. За это время ни одной задержки выплат. Оформили официально сразу, "
    "всё по-человечески. Коллектив нормальный, диспетчеры адекватные. Буду работать дальше.»"
)
...
def main_keyboard():
    return InlineKeyboardMarkup(
        ...
        [
            ...
            [InlineKeyboardButton("💬 Отзывы сотрудников", callback_data="reviews")],
        ]
    )
...
async def handle(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "reviews":
        await query.edit_message_text(REVIEWS, parse_mode="HTML", reply_markup=back_keyboard())
        return
